...
const PostShowcaseReverse = () => {
  ...
  return (
    <article className='mt-12 grid grid-cols-[50%,40%] place-content-between'>
      <div className='mt-32 flex h-full w-[498px] flex-col gap-7'>
      ...
      <div className='relative h-[550px] w-[500px] rounded-xl bg-gradient-to-b from-[#fe7587] to-blue-500 pr-8 pt-12'>
        <img
          src={post.thumbnail}
          alt={post.title}
          height={550}
        ...
        <img
          src={'/main.png'}
          alt={'test'}
          className='absolute -bottom-20 -left-20 h-[200px] w-[400px] rounded-lg object-cover shadow-xl shadow-black brightness-95'
        />
...
export default PostShowcaseReverse;
